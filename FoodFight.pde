...
boolean gameIntroduction = false;
...
void draw() {
  ...
  void smashMashTitle() {
    if (gameTitle == false) {
      ...
      image (titleAnimation, 0, 0);
      //    title();
    }
  }
  
  void gameIntroduction() {
    if (gameIntroduction == false) {
      image(introductionAnimation, 0, 0);
    }
  }
 ...
 if ((gameTitle == true) && (gameIntroduction == true)) {
      if ((p1Selected == false) && (gameTitle == true) && (gameIntroduction == true)) {
        if (key=='1') {
          p1Selected = true;
          p1Selection = 1;
        }
      ...
      if ((p2Selected == false) && (gameTitle == true) && (gameIntroduction == true)) {
        if (key=='5') {
          p2Selected = true;
          p2Selection = 1;
        }
